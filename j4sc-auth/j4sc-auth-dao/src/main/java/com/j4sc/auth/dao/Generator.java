...
public class Generator {
    // 根据命名规范，只修改此常量值即可
    private static String MODULE = "j4sc-auth";
    private static String DATABASE = "j4sc";
    private static String TABLE_PREFIX = "auth_";
    private static String PACKAGE_NAME = "com.j4sc.auth";
