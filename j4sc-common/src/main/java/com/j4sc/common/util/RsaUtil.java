 ...
 * @Description: RSA工具
 * @Author: LongRou
 * @CreateDate: 2018 2018/3/26 14:40
 * @Version: 1.0
 **/
public class RsaUtil {
    ...
    public static String toHexString(byte[] b) {
        return new String(Base64Utils.encode(b));
    }

    public static final byte[] toBytes(String s) throws IOException {
        return Base64Utils.decodeFromString(s);
    }
...
//        keyPairGenerator.initialize(1024, secureRandom);
//        KeyPair keyPair = keyPairGenerator.genKeyPair();
//        //System.out.println(toBytes(new String(keyPair.getPublic().getEncoded())));
//        System.out.println(new String(generatePublicKey("123")));
//    }
}
