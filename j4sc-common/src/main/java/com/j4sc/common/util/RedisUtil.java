 ...
 * @Description: Redis工具
 * @Author: LongRou
 * @CreateDate: 2018 2018/3/19 17:44
 * @Version: 1.0
 **/
@Component
@ConfigurationProperties("master.redis")
public class RedisUtil {
    ...
    public  void setPASSWORD(String PASSWORD) {
        RedisUtil.PASSWORD =  AESUtil.aesDecode(PASSWORD);
    }
    ...
    public static String toStrings() {
        return "RedisUtil{ss}"+MAX_WAIT+","+PASSWORD+","+TIMEOUT;
    }
}
