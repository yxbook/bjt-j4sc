...
import static com.j4sc.common.util.StringUtil.lineToHump;

/**
 * @Description: MB代码生成类
 * @Author: LongRou
 * @CreateDate: 2018 2018/3/14 14:23
 * @Version: 1.0
 **/
public class MybatisPlusGeneratorUtil {
    ...
    public static void generator(
        ...
        if (os.toLowerCase().startsWith("win")) {
            service_vm = MybatisPlusGeneratorUtil.class.getResource(service_vm).getPath().replaceFirst("/", "");
            serviceImpl_vm = MybatisPlusGeneratorUtil.class.getResource(serviceImpl_vm).getPath().replaceFirst("/", "");
        } else {
            service_vm = MybatisPlusGeneratorUtil.class.getResource(service_vm).getPath();
            serviceImpl_vm = MybatisPlusGeneratorUtil.class.getResource(serviceImpl_vm).getPath();
        }

        String targetProject = module + "/" + module + "-dao";
        String basePath = MybatisPlusGeneratorUtil.class.getResource("/").getPath().replace("/target/classes/", "").replace(targetProject, "").replaceFirst("/", "");
...
//            String targetProjectSqlMap = basePath + module + "/" + module + "-rest-service";
